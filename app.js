...
// Transactions
while (true) {
    let choice = readlinesync.keyInSelect(["Withdraw", "Fast Cash", "Balance Check"], "What you want to do now?\n") + 1;
  ...
  */
    ...
    switch (choice) {
        ...
        case 2:
            console.log("Fast Cash");
            let fastCash = readlinesync.keyInSelect(["$100", "$500", "$1000", "$5000", "$10000"], "How much do you want withdraw using Fast Cash?") + 1;
            while (true) {
                if (fastCash > balance) {
                    console.log('Insufficient Balance.');
                    break;
